...
All scripts, software, datasets, and manuals are available from the [PiEEG Club GitHub](https://github.com/pieeg-club). For questions, use the PiEEG [Discord](https://discord.gg/5Ps24p47).
