...
<Tabs items={['CDN', 'Package manager', 'Script tag (local)', 'Bundler import']}>
<Tabs.Tab>
...
<Tabs.Tab>
Install directly from the GitHub repo — no registry account required:
...
# or
yarn add pieeg-club/PiEEG-server
```
...
<Tabs.Tab>
Works with any bundler (Vite, webpack, Rollup, esbuild):

```js
import PiEEG from '@pieeg/sdk';   // when installed via package manager
// or, from a local copy:
const PiEEG = require('./pieeg.js');
