...
For a browser take that pairs the live bio stream with 33-point camera pose (points only, two clocks, no pixels), see [BioPose Recorder](/software/features/biopose). That path does not write the server CSV above.
